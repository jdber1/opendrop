...
class InputFields(CTkFrame):
    ...
    def create_top_input_fields(self):
        ...
        self.top_input_frame.pack(fill="x", padx=15, pady=(0, 16))  # Padding bottom margin of 16

        # Create user input fields in the top frame (row 1)
        self.top_user_input_fields_1 = create_user_input_fields(self.top_input_frame)  # First set
        self.top_user_input_fields_2 = create_analysis_method_fields(self.top_input_frame)  # Second set

        # Adjust the weight of the columns for resizing
        self.top_input_frame.grid_columnconfigure(0, weight=55)  # Adjust first column weight
        self.top_input_frame.grid_columnconfigure(1, weight=35)  # Adjust second column weight

        # Pack the two input field sets in the top input frame
        self.top_user_input_fields_1.pack(side="left", fill="both", expand=True, padx=(0, 24))  # First input set (55%)
        self.top_user_input_fields_2.pack(side="right", fill="both", expand=True, padx=(24, 0))  # Second input set (35%)
    ...
    def create_bottom_input_fields(self):
        ...
        self.bottom_user_input_fields = create_fitting_view_fields(self.bottom_input_frame)  # Third set
