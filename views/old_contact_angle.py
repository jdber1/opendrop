...
class UserInterface(tk.Toplevel):
    ...
    def create_user_inputs(self):
        ...
        self.density_outer = FloatEntryStyle(self, user_input_frame, "Continuous density (kg/m"u"\u00b3""):", rw=4,state_specify='normal') #, label_width=LABEL_WIDTH)
        self.needle_diameter = FloatComboboxStyle(self, user_input_frame, "Needle diameter (mm):", NEEDLE_OPTIONS, rw=5,state_specify='normal') #, label_width=LABEL_WIDTH)
    ...
    def create_plotting_checklist(self):
        ...
        self.residuals_boole = CheckButtonStyle(self, plotting_clist_frame, "Residuals", rw=0, cl=0,state_specify='normal')
        self.profiles_boole = CheckButtonStyle(self, plotting_clist_frame, "Profiles", rw=1, cl=0,state_specify='normal')
        self.IFT_boole = CheckButtonStyle(self, plotting_clist_frame, "Physical quantities", rw=2, cl=0,state_specify='normal')
