...
from opendrop.app.ift.analysis_saver import IFTAnalysisSaverOptions, ift_save_dialog_cs
...
ift_results_cs = ComponentSymbol()  # type: ComponentSymbol[Gtk.Widget]


@ift_results_cs.view(options=['footer_area'])
class IFTResultsView(View['IFTResultsPresenter', Gtk.Widget]):
