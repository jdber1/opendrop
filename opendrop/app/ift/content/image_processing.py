...
class _IFTImageProcessingFormPresenter(ImageProcessingFormPresenter[IFTImageProcessingFormView]):
...
class IFTImageProcessingFormPresenter(WizardPageWrapperPresenter):
    create_presenter = _IFTImageProcessingFormPresenter
